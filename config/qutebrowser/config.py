...
##  but the settings here will overide if they confillct
...
## unlimited
## Type: Int
c.completion.cmd_history_max_items = 60
...
## unlimited
## Type: Int
c.completion.web_history_max_items = 80
...
c.url.searchengines = {
	...
	'wk': 'https://www.wikipedia.org/search-redirect.php?family=wikipedia&language=en&search={}&language=en&go=Go',
	"ddg": "https://duckduckgo.com/?q={}",
    "gs": "https://www.google.com/search?q={}",
    "gi": "https://www.google.com/search?tbm=isch&q={}",
    "gm": "https://maps.google.com/maps?q={}",
    "awiki": "https://wiki.archlinux.org/index.php?title=Special:Search&search={}&go=Go",
	}
#
## Page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = "file:///home/dka/my-home-page/index.html"
...
config.bind('gs', 'set-cmd-text -s :open -t gs')
config.bind('gi', 'set-cmd-text -s :open -t gi')
config.bind (',V', 'spawn urxvt -e youtube-dl --all-subs  {url}')
config.bind(',ytv', 'spawn urxvt -e youtube-dl -ic {url}')
config.bind(',yta', 'spawn urxvt -e youtube-dl -xic {url}')
#
