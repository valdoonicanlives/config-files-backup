" NOTE TO ME DK - It also puts a nice Bookmarks menu in the vim toolbar (Gvim)
" File: bookmarks.vim
...
" bookmarking files and directories in gvim the gui vim not console vim.  
" 
"    Bookmark Features:
