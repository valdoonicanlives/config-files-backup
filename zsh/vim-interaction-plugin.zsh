#
# See README.md
#  I think this is only for Gvim DK, yes see line 64
# you need to have gvimalready running or you get  "no server named "GVIM"
# Derek Wyatt (derek@{myfirstnamemylastname}.org
# example
# vo /tmp/myfile.scala     to open file
# vvsp /tmp/myfile.scala   load in a vertical split
#  vhsp -aG /tmp/myfile.scala   horizontal split
